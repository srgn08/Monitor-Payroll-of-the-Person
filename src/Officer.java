...
public class Officer extends Personnel{
	...
	private final int baseSalary=1800;
	 ...
	 /**
		 * this is officer constructor
		 * @param name
		 * @param registration_number
		 * @param position
		 * @param year
		 */ 
	public Officer(String name,String registration_number,String position, int year)
	{
	...
	public int overWorkSalary()
	{
		...
		{
			if(workHour[j]>=40 && workHour[j]<=50)
			{
